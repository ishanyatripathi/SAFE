...
class HandsController:
    ...
    def __init__(self, scroll_callback=None, zoom_callback=None):
        ...
        # Scroll control tuning
        self.scroll_sensitivity = 30   # Higher = slower movement
        self.dead_zone = 20            # Prevent jitter in center

        # Frame center reference (will auto update)
        self.center_x = 320
        self.center_y = 240
